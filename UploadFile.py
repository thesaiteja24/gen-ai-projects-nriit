...
def delete_from_drive(file_id):
    ...
    :param file_id: The ID of the file to be deleted from Google Drive.
    ...
    try:
        ...
        raise RuntimeError(f"An error occurred during file deletion: {str(e)}")

def upload_to_drive(file):
    """
    Upload a file to Google Drive and return the shareable link and file ID.

    :param file: File object from Flask's `request.files`.
    :return: Tuple containing shareable link and file ID of the uploaded file.
    """
    try:
